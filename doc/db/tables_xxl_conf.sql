...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='服务配置数据';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='服务配置数据，操作日志';
...
VALUES  (1, 'test', '测试环境', '用于开发者和测试人员进行单元测试、集成测试等，以确保代码的功能正确无误', now(), now()),
        ...
        (3, 'prod', '生产环境', '服务程序实际运行并面向外部用户的环境', now(), now());

INSERT INTO `xxl_conf_application` (id, appname, name, `desc`, add_time, update_time)
VALUES (1, 'xxl-conf-sample', '示例服务', '示例服务，演示使用', '2025-01-18 20:03:13', '2025-01-18 20:03:13');
