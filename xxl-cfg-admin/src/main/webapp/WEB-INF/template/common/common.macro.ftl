<#macro commonStyle>
    ...
    <!-- jvectormap -->
    <link rel="stylesheet" href="${request.contextPath}/static/lte/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    <!-- Theme style -->
    ...
    <link rel="stylesheet" href="${request.contextPath}/static/lte/dist/css/skins/_all-skins.min.css">
...
<#macro commonScript>
    ...
    <!-- FastClick -->
    <script src="${request.contextPath}/static/lte/plugins/fastclick/fastclick.min.js"></script>
    <!-- AdminLTE App -->
    <script src="${request.contextPath}/static/lte/dist/js/app.min.js"></script>
    <!-- Sparkline -->
    <script src="${request.contextPath}/static/lte/plugins/sparkline/jquery.sparkline.min.js"></script>
    <!-- jvectormap -->
    <script src="${request.contextPath}/static/lte/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="${request.contextPath}/static/lte/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <!-- SlimScroll 1.3.0 -->
    <script src="${request.contextPath}/static/lte/plugins/slimScroll/jquery.slimscroll.min.js"></script>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click" ><a href="${request.contextPath}/zkcfg"><i class="fa fa-circle-o text-red"></i> <span>配置管理</span></a></li>
				...
				<li class="treeview nav-click">
					<a href="#"><i class="fa fa-dashboard"></i> <span>配置中心</span><i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<li class="nav-click" ><a href="${request.contextPath}/zkcfg"><i class="fa fa-circle-o"></i>配置管理</a></li>
						<li class="nav-click" ><a href="${request.contextPath}/help"><i class="fa fa-circle-o"></i>使用说明</a></li>
					</ul>
				</li>
