package com.xxl.conf.admin.business.openapi.registry.biz;

import com.xxl.conf.admin.business.openapi.registry.config.RegistryBootstrap;
...
public class RegistryServiceImpl implements RegistryService {
    ...
    public Response<String> register(RegisterRequest request) {
        // invoke
        RegistryBootstrap.getInstance().getRegisterHelper().registry(request);
    ...
    public Response<String> unregister(RegisterRequest request) {
        // invoke
        RegistryBootstrap.getInstance().getRegisterHelper().unregister(request);
        return Response.ofSuccess();
    }

    @Override
    public Response<DiscoveryData> discovery(DiscoveryRequest request) {
        // invoke
        return RegistryBootstrap.getInstance().getRegistryCacheHelpler().discoveryOnLineInstance(request);
    }

    @Override
    public Response<String> monitor(DiscoveryRequest request) {
        // redirect: monitor2
        return null;
    }
