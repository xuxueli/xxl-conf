package com.xxl.conf.admin.business.openapi.registry.config;

import com.xxl.conf.admin.business.mapper.*;
import com.xxl.conf.admin.business.openapi.registry.thread.*;
...
public class RegistryBootstrap implements InitializingBean, DisposableBean {
    ...
    public static RegistryBootstrap getInstance() {
        return instance;
    }
