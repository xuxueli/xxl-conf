package com.xxl.conf.admin.business.openapi.confdata.config;

import com.xxl.conf.admin.business.mapper.ConfDataMapper;
import com.xxl.conf.admin.business.openapi.confdata.thread.ConfDataCacheHelpler;
import com.xxl.conf.admin.business.openapi.confdata.thread.ConfDataDeferredResultHelpler;
...
@Configuration
public class ConfDataBootstrap implements InitializingBean, DisposableBean {
    private static Logger logger = LoggerFactory.getLogger(ConfDataBootstrap.class);

    // ---------------------- instance ----------------------
    private static ConfDataBootstrap instance;
    public static ConfDataBootstrap getInstance() {
        return instance;
    }
