...
public class SpringXxlConfBootstrap implements InitializingBean, DisposableBean, ApplicationContextAware, SmartInstantiationAwareBeanPostProcessor {
	...
	public boolean postProcessAfterInstantiation(final Object bean, final String beanName) throws BeansException {
		...
		if (!beanName.equals(SpringXxlConfBootstrap.class.getName())) {
	...
	public static void refreshBeanField(Object bean, final SpringBeanRefreshListener.BeanField beanField, final String value){
		...
		if (fieldItem != null) {
			try {
				...
				logger.info(">>>>>>>>>>> xxl-conf, SpringXxlConfBootstrap refreshBeanField[reflect] success, {}#{}:{}", beanField.getBeanName(), beanField.getFieldName(), value);
		...
		if (propertyDescriptor!=null && propertyDescriptor.getWriteMethod() != null) {
			...
			logger.info(">>>>>>>>>>> xxl-conf, SpringXxlConfBootstrap refreshBeanField[set] success, {}#{}:{}", beanField.getBeanName(), beanField.getFieldName(), value);
		} else {
			// reflect
		}*/
